...
/**
 * FtpListRequest is the class associated to the LIST ftp request
 * LIST allows the user to list a directory with full available information for the files
 *
 * @author Quentin Warnant
 * @version 1.0
 */
public class FtpListRequest extends FtpDataRequest {
     ...
     */
    public FtpListRequest(String commandLine, String currentDirectory, char currentType,
                          Socket socket) {
    ...
    public FtpResponse process() throws IOException {
        ...
        String fileList = FtpUtils.listFilesInFolder(targetDirectory, false, true);
