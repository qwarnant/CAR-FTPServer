...
public class FtpThread extends Thread {
    ...
    public void handleInputRequest() {
        ...
        try {
            ...
            } else if (command.equals(FtpConstants.FTP_CMD_DELE)) {

                // Make a DELE request
                FtpDeleRequest rdele = new FtpDeleRequest(commandLine,
                        this.currentDirectory, this.currentUsername);
                this.storeAndExecute(rdele);
            ...
            } else if (command.equals(FtpConstants.FTP_CMD_SYST)) {
                // Make a SYST request
                FtpSystRequest rsyst = new FtpSystRequest(commandLine);
                this.storeAndExecute(rsyst);
