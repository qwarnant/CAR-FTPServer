...
/**
 * FtpThread is the class that handles all the ftp thread logic
 * A FtpThread is created when a new client is connected on the ftp server
 *
...
public class FtpThread extends Thread {
    ...
    /**
     * This attribute contains all history of the
     * ftp request of the thread
     ...
     * Class constructor
     *
     * @param socket Socket the new client socket connection
     * @throws IOException
     */
     ...
     * <p/>
     * If the request is not implemented in the server, the
     * server answers with the correct error code
     */
    ...
    /**
     * This method stores the request in the request history
     * and executes the specified ftp request of the client
     *
     * @param request FtpRequest the specified ftp request
     * @throws IOException
     */
     ...
     *
     * @param running boolean true if the thread is running false otherwise
     */
